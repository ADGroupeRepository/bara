  ...
  },
  {
    ...
    sidebarLinks: [
      { name: "Accueil", href: "/rh", icon: "Home" },
      {
        ...
        icon: "Building",
        items: [
          { name: "Employés", href: "/rh/employees" },
          { name: "Types d'emploi", href: "/rh/employment-types" },
          { name: "Succursales", href: "/rh/branches" },
          { name: "Départements", href: "/rh/departments" },
          { name: "Fonctions", href: "/rh/designations" },
          { name: "Groupes d'employés", href: "/rh/employee-groups" },
          { name: "Assurance santé", href: "/rh/health-insurance" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Pointage employé", href: "/rh/employee-checkin" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "Feedback employé", href: "/rh/performance/feedback" },
